<html>
<head>
	<title>KouSik PrIvate ChEcKer</title>
...
<div class="card col-sm-8">
  <h5 class="card-body h6">CC CHECKER - Material Design By Kousik / With Proxy File</h5>
  <div class="card-body">
    <center><span>[#Cc Checker 1]</span></center>
<div class="md-form">
	<div class="col-md-12">
  <textarea type="text" style="text-align: center;" id="lista" class="md-textarea form-control" rows="2"></textarea>
  <label for="lista">Enter Card Details</label>
</div>
</div>
<center>
...
<footer >
    ...
    <div class="footer-copyright text-center py-3">This Checker Made By Kousik


    <div class="footer-copyright text-center py-3">Anyone Interested To By This Checker To Contact Us


    <div class="footer-copyright text-center py-3">Contact Us:


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="https://api.whatsapp.com/send?phone=+918346923732"> WhatsApp</a>
    </div>


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="https://github.com/KousikTheRoy/"> Github</a>
    </div>


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="https://twitter.com/Kousik_The_Roy/"> Twitter</a>
    </div>


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="https://m.facebook.com/The.Name.Is.BlackArrow/"> Facebook</a>
    </div>


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="https://www.instagram.com/kousik_the_roy/"> Instagram</a>
    </div>


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="tel:+917047368592/"> Call</a>
    </div>


    <div class="footer-copyright text-center py-3">Contact To Kousik At:
      <a href="mailto:%20contact@kousikroy.com"> Mail</a>
    </div>
